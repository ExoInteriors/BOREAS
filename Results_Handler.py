...
class ResultsHandler:
    ...
    def water_loss(df):
        ...
        ax.legend(handles=teq_handles, title='T$_{eq}$', loc='lower right', fontsize=15, title_fontsize=15, frameon=False)
        
        depletion_handles = [Line2D([0], [0], marker='*', color='w', markerfacecolor='none',
                markeredgecolor='black', markersize=15, label='Water-depleted')]
        ax.legend(handles=depletion_handles, loc='upper left', fontsize=15, frameon=False)
