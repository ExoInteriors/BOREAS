class ModelParams:
    ...
    def __init__(self):
        ...
        # - Mean molecular weights for fully dissociated species assuming 
        # *strong* photoevaporation that fully dissociates the species
        self.mmw_HHe_outflow = self.mmw_H                       # 1, full dissociation gives free H atoms (mmw = 1 per H atom)
        ...
        self.X_HHe  = 0.9
        self.X_H2O  = 0.1
        self.N_HHe  = self.X_HHe / self.mmw_HHe_outflow         # = 0.9 / 1 = 0.9
        self.N_H2O  = self.X_H2O / self.mmw_H2O_outflow         # = 0.1 / 6 ≈ 0.01667
        self.N_tot  = self.N_HHe + self.N_H2O                   # total free particles per unit mass
        self.mmw_HHe_10H2O_outflow = 1 / self.N_tot             # Max mean molecular weight (90% of H, H, 10% of H, H, and O) assuming full dissociation of H2 and water
